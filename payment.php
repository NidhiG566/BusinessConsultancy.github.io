...
<body>
  ...
  <section style="margin-top: 116px;margin-bottom: 20px;">
    <div class="container">
			<!-- code here -->
			<div class="row">
        <div class="col-md-6">
          <div class="card">
            ...
            <form class="card-form">
              <div class="input">
                <input type="text" class="input-field" name="name" id="name" value="" required />
                <label class="input-label">Full name</label>
              </div>
              <div class="input">
                <input type="text" class="input-field" name="amt" id="amt" required />
              ...
              <div class="action">
              <button class="btn btn-custom" type="button" name="btn" id="btn" value="Pay Now" onclick="pay_now()">PAY NOW</button>
              </div>
            </form>
            <div class="card-info">
        ...
        <div class="col-md-6">
          <div class="card_profile">
            ...
            <div class="links">
              <div class="row">
              <div class="col-md-6">
                  <a target="_blank" href="https://codepen.io/l-e-e/"><button class="button_p">Call-Us</button></a>
                </div>
                <div class="col-md-6">
                  <a target="_blank" href="https://codepen.io/l-e-e/"><button class="button_p"> Whatsapp</button></a>
                </div>
              </div>
            </div>
          </div>
