...
<body>
  ...
  <section class="ftco-section">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6">
            <h3>Annual Compliances for Nidhi Company</h3>
            <p>A Nidhi Company is a type of non-banking financial company (NBFC) and regulated by the Ministry of Corporate Affairs and must comply with the various regulations and guidelines prescribed by the Reserve Bank of India that is registered under the Companies Act, 2013 in India. The primary objective of a Nidhi Company is to cultivate the habit of thrift and savings among its members and to lend funds to its members only for their mutual benefit.</p>
            <p>
            Nidhi companies are allowed to accept deposits and provide loans to their members.
            </p>
            <p>
            Nidhi companies are usually formed as a public limited company and require a minimum of 200 members to register. They must have a minimum net owned funds of Rs. 10 lakhs and must maintain a net owned fund to deposit ratio of at least 1:20.
            </p>
            ...
            <li><i class="fa fa-check"></i></span>Conduct of Board Meeting</li>
            <li><i class="fa fa-check"></i></span>Conduct of Annual General Meeting</li>
            </ul>
        </div>
        <div class="col-md-6"> 
          <div class="card">
